          ...
          <div key={`${rate.rateId}-${rateIndex}`} className="space-y-4">
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              <button
                ...
                className="bg-gradient-to-r from-orange-400 to-amber-500 text-white py-3 px-6 rounded-xl font-bold hover:scale-105 transition-all duration-300 flex items-center shadow-md hover:shadow-lg group"
              >
                Book This Studio

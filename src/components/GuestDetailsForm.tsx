      ...
      <div className="max-w-2xl mx-auto">
        ...
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          <div className="flex gap-4 pt-6">
            <button type="button" onClick={onBack} className="flex-1 py-2 md:py-3 px-6 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors font-medium">
              Back to Search
            </button>
            <button type="submit" className="flex-1 py-2 md:py-3 px-6 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium flex items-center justify-center">

            ...
            return (
              <div key={`${unit.buildingId}-${unit.inventoryTypeId}-${index}`} className="bg-card rounded-lg shadow-sm overflow-hidden border">
                <div className="flex flex-col md:flex-row">
                  ...
                  {/* Studio Details */}
                  <div className="mb-6">
                    <h4 className="text-lg font-semibold text-foreground mb-4">Studio details</h4>
                    <div className="flex flex-wrap gap-6">
                      <div className="flex items-center gap-2">
                        <img src="https://cdn.prod.website-files.com/5ffc799abc54c384e95bfbf9/67bc361a17072666a6cbbd39_Sqm.svg" alt="Area" className="w-6 h-6" />
                        <span className="text-foreground">{studioDetails.sqm}</span>
                        <span className="text-foreground">Sqm</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <img src="https://cdn.prod.website-files.com/5ffc799abc54c384e95bfbf9/67bc361a94a2a8db6df5d799_ShowerFull.svg" alt="Bathroom" className="w-6 h-6" />
                        <span className="text-foreground">{studioDetails.bathroom}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <img src="https://cdn.prod.website-files.com/5ffc799abc54c384e95bfbf9/67bc36159d792c24da1fbee1_Kitchen.svg" alt="Kitchen" className="w-6 h-6" />
                        <span className="text-foreground">{studioDetails.kitchen}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <img src="https://cdn.prod.website-files.com/5ffc799abc54c384e95bfbf9/67bc37969fc4e91319b9c12c_Floorplan.svg" alt="Rooms" className="w-6 h-6" />
                        <span className="text-foreground">{studioDetails.rooms} Room</span>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Shared Spaces */}
                  <div className="mb-6">
                    <h4 className="text-lg font-semibold text-foreground mb-4">Shared Spaces</h4>
                    <div className="flex flex-wrap gap-4">
                      <div className="flex items-center gap-2">
                        <img src="https://cdn.prod.website-files.com/606d62996f9e70103c982ffe/67b88820e5f234b304d019fa_Courtyard.svg" alt="Courtyard" className="w-5 h-5" />
                        <span className="text-foreground">Courtyard</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <img src="https://cdn.prod.website-files.com/606d62996f9e70103c982ffe/67b887637909e25b290b20aa_Cinema.svg" alt="Cinema" className="w-5 h-5" />
                        <span className="text-foreground">Cinema Room</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <img src="https://cdn.prod.website-files.com/606d62996f9e70103c982ffe/67b8881562fca9481748de55_Coworking.svg" alt="Coworking" className="w-5 h-5" />
                        <span className="text-foreground">Co-working Space</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <img src="https://cdn.prod.website-files.com/606d62996f9e70103c982ffe/67b8878163c1592df61938d5_Gym.svg" alt="Gym" className="w-5 h-5" />
                        <span className="text-foreground">Gym</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <img src="https://cdn.prod.website-files.com/606d62996f9e70103c982ffe/67b88862542d44b3535ed8c7_Sauna.svg" alt="Sauna" className="w-5 h-5" />
                        <span className="text-foreground">Sauna</span>
                      </div>
                    </div>
                  </div>

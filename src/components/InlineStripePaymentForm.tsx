                ...
                <div className="space-y-4 text-sm">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <div className="text-gray-600">{formatDateWithWeekday(bookingDetails.checkIn)}</div>
                    </div>
                    <div>
                      <div className="font-medium text-gray-700 mb-1">Check-out:</div>
                      <div className="text-gray-600">{formatDateWithWeekday(bookingDetails.checkOut)}</div>
                    </div>
                  </div>
                </div>
              </div>

...
interface InlineGuestDetailsFormProps {
...
const InlineGuestDetailsForm: React.FC<InlineGuestDetailsFormProps> = ({
  selectedUnit,
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-sm p-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-8">Guest Details</h1>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Booking Summary */}
            <div className="bg-gray-50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-gray-800 mb-4">Booking Summary</h3>
              <p className="text-gray-600 mb-4">{selectedUnit.inventoryTypeName} - {selectedUnit.buildingName}</p>
              ...
              <div className="border-t border-gray-200 pt-4 mt-4">
                ...
                <div className="flex justify-between items-center border-t border-gray-200 pt-3">
                  ...
                  <div className="text-right">
                    <div className="text-2xl font-bold text-gray-900">{formatCurrency(selectedUnit.selectedRate.totalPrice)}</div>
                    <div className="text-sm text-gray-500">(VAT incl.)</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <form onSubmit={onSubmit} className="space-y-6">
                ...
                <div className="flex gap-4 pt-6">
                  <button
                    type="button"
                    onClick={onBack}
                    className="px-8 py-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-gray-200"
                  >
                    Back
                  </button>
                  <button
                    type="submit"
                    className="flex-1 px-8 py-3 text-sm font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 flex items-center justify-center gap-2"
                  >
...
export default InlineGuestDetailsForm;
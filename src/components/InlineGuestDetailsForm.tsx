        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-gray-600 mb-3 text-sm">{selectedUnit.inventoryTypeName} - {selectedUnit.buildingName}</p>
               ...
               <div className="border-t border-gray-200 pt-3 mt-3">
                 ...
                 <div className="flex justify-between items-center border-t border-gray-200 pt-2">
                   ...
                   <div className="text-right">
                     <div className="text-xl font-bold text-gray-900">{formatCurrency(selectedUnit.selectedRate.totalPrice)}</div>
                ...
                <div>
                 ...
                 <div className="flex gap-3 pt-4">
                   <button
                     type="button"
                     onClick={onBack}
                     className="px-6 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-gray-200"
                   >
                     Back
                   </button>
                   <button
                     type="submit"
                     className="flex-1 px-6 py-2 text-sm font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 flex items-center justify-center gap-2"
                   >
